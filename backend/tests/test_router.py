...
class TestRouterConfig:
    def test_all_agents_listed(self):
        expected = {"chat", "search", "coding", "pdf", "ppt", "image", "rag", "research_rag"}
...
class TestAgentState:
    def test_initial_state_has_all_fields(self):
        ...
        required_fields = {
            "prompt", "agent", "conversation_id", "request_id",
            "ai_response", "search_results", "images",
            "rag_context", "rag_sources", "orchestration_plan", "token_usage",
        }
...
class TestGraphStructure:
    ...
    def test_graph_has_expected_nodes(self):
        ...
        expected = {"router", "search", "chat", "coding", "pdf", "ppt", "image", "rag_research"}
